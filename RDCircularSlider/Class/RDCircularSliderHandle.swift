...
public enum RDCircularSliderHandleType: Int, RawRepresentable {
    case smallCircle = 0,
    mediumCircle,
    largeCircle,
...
@IBDesignable
public class RDCircularSliderHandle: CALayer {
    ...
    private var slider: RDCircularSlider {
        return delegate as! RDCircularSlider
    }
    ...
    internal var handleType: RDCircularSliderHandleType = .largeCircle {
        didSet {
            setNeedsDisplay()
        }
    }
