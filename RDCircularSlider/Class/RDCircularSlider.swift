...
public protocol RDCircularSliderProtocol: class {
    // Acts as an abstract class only - not to be used
}

public protocol RDCircularSliderDelegate: RDCircularSliderProtocol {
    func circularSlider(_ slider: RDCircularSlider, valueChangedTo value: Double, fromUser: Bool)   // fromUser indicates whether the value changed by sliding the handle (fromUser == true) or through other means (fromUser == false)
    func circularSlider(_ slider: RDCircularSlider, startedTrackingWith value: Double)
    func circularSlider(_ slider: RDCircularSlider, endedTrackingWith value: Double)
    func circularSlider(_ slider: RDCircularSlider, directionChangedTo value: RDCircularSliderDirection)
    func circularSlider(_ slider: RDCircularSlider, revolutionsChangedTo value: Int)
}

extension RDCircularSliderDelegate {
    // Optional Methods
    func circularSlider(_ slider: RDCircularSlider, startedTrackingWith value: Double) {}
    func circularSlider(_ slider: RDCircularSlider, endedTrackingWith value: Double) {}
    func circularSlider(_ slider: RDCircularSlider, directionChangedTo value: RDCircularSliderDirection) {}
...
public enum RDCircularSliderDirection {
    case clockwise, counterclockwise, none
}


@objc(RDCircularSlider)
@IBDesignable
public class RDCircularSlider: UIControl {
    ...
    weak public var delegate: RDCircularSliderProtocol? = nil
    
    /** A middle ground for casting the delegate */
    private weak var castDelegate: RDCircularSliderDelegate? {
        get {
            return delegate as? RDCircularSliderDelegate
        }
        set {
            delegate = newValue
        }
    ...
    public var slidingDirection: RDCircularSliderDirection = .none
    ...
    let handle = RDCircularSliderHandle()
    ...
    public var handleType: RDCircularSliderHandleType {
        set {
    ...
    override public func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        func changeSlidingDirection(_ direction: RDCircularSliderDirection) {
